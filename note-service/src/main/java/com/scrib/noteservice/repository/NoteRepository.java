package com.scrib.noteservice.repository;
...
public interface NoteRepository extends JpaRepository<Note, UUID> {
    ...
    Optional<Note> findByIdAndNotDeleted(@Param("id") UUID id);
    
    @Query("SELECT n FROM Note n WHERE n.id = :id AND n.visibility = 'PUBLIC' AND n.deletedAt IS NULL")
    Optional<Note> findPublicById(@Param("id") UUID id);
